...
echo "Monocular PNG: $LOCAL_TARGET_DIR/${LABEL}_monocular_plot.png"
echo "Monocular LaTeX: $LOCAL_TARGET_DIR/table_publication_monocular.tex"
echo "Stereo PNG: $LOCAL_TARGET_DIR/${LABEL}_stereo_plot.png"
echo "Stereo LaTeX: $LOCAL_TARGET_DIR/table_publication_stereo.tex"
